...
List<Object[]> getestBySpecimenDBSForOneRegimen(@Param("regimenId") Long regimenId);
 ...
 List<Object[]> getestBySpecimenPSCForOneRegimen(@Param("regimenId") Long regimenId);
  ...
  //EDTA PLASMA
  @Query(value = " SELECT TO_CHAR(a.drcpt, 'Mon-YYYY') AS date, a.drcpt, " +
  " COUNT(t.id) AS total_tests " +
  " FROM dashboard.region r " +
  " INNER JOIN dashboard.district d ON r.id = d.region_id" +
  " INNER JOIN dashboard.site s ON d.id = s.district_id " +
  ...
  " AND a.drcpt BETWEEN '2022-01-01' AND CURRENT_DATE " +
  " GROUP BY a.drcpt, TO_CHAR(a.drcpt, 'Mon-YYYY'), st.label  " +
  " ORDER BY a.drcpt ASC, TO_CHAR(a.drcpt, 'Mon-YYYY');", nativeQuery = true)
...
@Query(value =  " SELECT cdc_age_cat.id, pat.gender, cdc_age_cat.label cdc_age_label, rg.name, " +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_SUPERIEUR_OU_EGAL_1000, " +
" SUM(CASE WHEN a.converted_result < 1000 THEN 1 ELSE 0 END ) AS TOTAL_INFERIEUR_A_1000, " +
" SUM(CASE WHEN a.converted_result = 0 THEN 1 ELSE 0 END) AS TOTAL_INDETECTABLE_LL, " +
" SUM(CASE WHEN a.converted_result = -1 THEN 1 ELSE 0 END) AS TOTAL_INVALIDE_XXXX, " +
...
" pat.gender = :sex AND " +
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY pat.gender, cdc_age_cat.id, cdc_age_cat.label, rg.name, EXTRACT(YEAR FROM a.drcpt)" +
...
" SUM(CASE WHEN st.label = 'DBS' THEN 1 ELSE 0 END) AS TOTAL_DBS, " +
" SUM(CASE WHEN st.label = 'PSC' THEN 1 ELSE 0 END) AS TOTAL_PSC, " +
" SUM(CASE WHEN st.label = 'Tube EDTA - Violet' THEN 1 ELSE 0 END) AS TOTAL_EDTA_PLASMA, " +
" SUM(1) AS total_tests " +
" FROM dashboard.region r " +
" INNER JOIN dashboard.district d ON r.id = d.region_id" +
" INNER JOIN dashboard.site s ON d.id = s.district_id " +
" INNER JOIN dashboard.patient p ON s.id = p.site_id" +
...
//NOMBRE DE TESTS REALISES POUR UNE ANNEE EN COURS SELON UNE CATEGORIE D'AGE

 @Query(value = "SELECT  ac.id, ac.label,  " +
 " SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_SUPERIEUR_OU_EGAL_1000, " +
 " SUM(CASE WHEN a.converted_result < 1000 THEN 1 ELSE 0 END ) AS TOTAL_INFERIEUR_A_1000, " +
 " SUM(CASE WHEN a.converted_result = 0 THEN 1 ELSE 0 END) AS TOTAL_INDETECTABLE_LL, " +
 " SUM(CASE WHEN a.converted_result = -1 THEN 1 ELSE 0 END) AS TOTAL_INVALIDE_XXXX, " +
 ...
 " ac.type = 'CDC CI' AND " +
 " EXTRACT(YEAR FROM a.drcpt) = :year " +
 " GROUP BY ac.id, ac.label, EXTRACT(YEAR FROM a.drcpt);", nativeQuery = true)
List<Object[]> getTestByAgeCategoryCdc(@Param("year") int year, @Param("ageCategoryId") Long ageCategoryId);

 //NOMBRE DE PATIENTS TESTES - MASCULIN ET SELON UNE CATEGORIE D'AGE
 @Query(value =  " SELECT pat.gender, cdc_age_cat.label," +
 " SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
 " SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
 " ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME, " +
 " ROUND(SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_NON_SUPPRIME " +
 ...
 " WHERE cdc_age_cat.type = 'CDC CI' AND " +   
 " pat.gender = :sex AND " +
 " cdc_age_cat.id = :ageCategoryId AND " +
 " EXTRACT(YEAR FROM a.drcpt) = :year  " +
 " GROUP BY pat.gender,cdc_age_cat.label, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
 List<Object[]> getPatientMaleByCdc(@Param("year") int year, @Param("ageCategoryId") Long ageCategoryId, @Param("sex") String sex);
 ...
 " JOIN dashboard.regimen rg on rg.id = a.regimen_id " +
 " WHERE cdc_age_cat.type = 'CDC CI' AND " +   
 " pat.gender <> 'M' AND pat.gender <> 'F' AND " +
 " cdc_age_cat.id = :ageCategoryId AND " +
 " EXTRACT(YEAR FROM a.drcpt) = :year  " +
 " GROUP BY pat.gender,cdc_age_cat.label, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
...
List<Object[]>patientTwon(@Param("year") int year);
    ...
    @Query(value = " SELECT TO_CHAR(a.drcpt, 'Mon-YYYY') AS date, pt.id, pt.name, " +
            ...
            " INNER JOIN dashboard.regimen rg ON a.regimen_id = rg.id " +
            " INNER JOIN dashboard.vl_reason vr ON a.vl_reason_id = vr.id " +
            " INNER JOIN dashboard.sample_type st ON a.samplsex2e_type_id = st.id " +
            " WHERE pt.id = :partnerId " +
            " AND a.drcpt BETWEEN '2023-01-01' AND CURRENT_DATE " +
            " AND st.label = 'Tube EDTA - Violet' " +
            " GROUP BY a.drcpt, TO_CHAR(a.drcpt, 'Mon-YYYY'), st.label, pt.id, pt.name " +
...
"JOIN VlReason vl ON a.vlReason.id = vl.id " +
"WHERE EXTRACT(YEAR FROM a.drcpt) = :year " +
"GROUP BY r.id, r.name, d.id, d.name, s.id, s.newSiteLongName, pt.name " +
"ORDER BY total_tests DESC, TOTAL_SUPPRIME DESC, TOTAL_NON_SUPPRIME DESC")
...
List<Object[]> getPatientNoDataForOneRegion(@Param("year") int year, @Param("regionId") Long regionId);
   ...
   List<Object[]> getViralLoadByGenderForAllRegion(@Param("year") int year);
...
@Query(value = "SELECT r.name, vl.name," +
" SUM(CASE WHEN a.convertedResult >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.convertedResult < 1000 AND a.convertedResult > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.convertedResult = 0 THEN 1 WHEN a.convertedResult < 1000 AND a.convertedResult > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.convertedResult >= 1000 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_NON_SUPPRIME " +
...
"JOIN Regimen reg ON a.regimen.id = reg.id " +
"JOIN VlReason vl ON a.vlReason.id = vl.id " +
"WHERE r.id = :regionId AND EXTRACT(YEAR FROM a.drcpt) = :year " +
"GROUP BY vl.name, r.name,  EXTRACT(YEAR FROM a.drcpt)")
...
" JOIN Patient p ON s.id = p.site.id " +
" JOIN Analysis a ON p.id = a.patient.id " +
" WHERE r.id = :regionId AND p.ageYears = 0 AND " + 
" EXTRACT(YEAR FROM a.drcpt) = :year " +
" GROUP BY EXTRACT(YEAR FROM a.drcpt)")
...
/************************************SUPPRESSION VIRALE - POUR UNE REGION***********************************************************/
   ...
   //PAR GENRE 
         ...
         " AND r.id = :regionId " +
         " GROUP BY EXTRACT(YEAR FROM a.drcpt) ")
     List<Object[]> getViralLoadMaleForOneRegion(@Param("regionId") Long regionId, @Param("year") int year, @Param("sex") String sex);
      ...
      " r.id = :regionId " +
      " GROUP BY EXTRACT(YEAR FROM a.drcpt)")
     List<Object[]> getViralLoadFemaleForOneRegion(@Param("regionId") Long regionId, @Param("year") int year, @Param("sex") String sex);
...
List<Object[]> getPatientMinusTenForOneRegion(@Param("regionId") Long regionId, @Param("year") int year);
 ...
 " r.id = :regionId " +
 " GROUP BY r.id, EXTRACT(YEAR FROM a.drcpt) ")
List<Object[]> getViralLoadMaleForOneRegion(@Param("year") int year, @Param("regionId") Long regionId);
...
" r.id = :regionId " +
" GROUP BY r.id, EXTRACT(YEAR FROM a.drcpt) ")
List<Object[]> getViralLoadFemaleForOneRegion(@Param("year") int year, @Param("regionId") Long regionId);
...
" r.id = :regionId " +
" GROUP BY r.id, EXTRACT(YEAR FROM a.drcpt) ")
List<Object[]> getViralLoadNothingForOneRegion(@Param("year") int year, @Param("regionId") Long regionId);
...
//SUPPRESSION DE CHARGE VIRALE PAR REGION
 ...
 " r.id = :regionId " +
 " GROUP BY r.id, r.name, EXTRACT(YEAR FROM a.drcpt) ")
List<Object[]> getViralLoadDeletionForOneRegion(@Param("year") int year, @Param("regionId") Long regionId);


//SUPPRESSION VIRALE - ANALYSE PAR REGIME THERAPEUTIQUE
...
//SUPPRESSION VIRALE - PAR REGION - POUR UN REGIME
@Query(value =  " SELECT reg.id, reg.name, rg.name," +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" WHERE a.regimen_id = :regimenId  AND  " +   
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY reg.id, reg.name, rg.name, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByRegionForOneRegimen(@Param("regimenId") Long regimenId, @Param("year") int year);


@Query(value =  " SELECT  part.id, part.name," +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" WHERE a.regimen_id = :regimenId  AND  " +   
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY part.id, part.name, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByPartnerForOneRegimen(@Param("regimenId") Long regimenId, @Param("year") int year);



@Query(value =  " SELECT  dis.id, dis.name, " +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" WHERE a.regimen_id = :regimenId  AND  " +   
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY dis.id, dis.name, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByDistrictForOneRegimen(@Param("regimenId") Long regimenId, @Param("year") int year);


@Query(value =  " SELECT  s.id, s.new_site_short_name, " +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
@Query(value =  " SELECT cdc_age_cat.id, cdc_age_cat.label, pat.gender, rg.name, " +
  " SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
  " SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
  " SUM (CASE WHEN a.converted_result >= 1000 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) AS TOTAL_SUPPRIME_ET_NON_SUPPRIME," +
  " ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME, " +
...
" WHERE cdc_age_cat.type = 'CDC CI' AND " +   
" pat.gender = :sex AND " +
" a.regimen_id = :regimenId AND " +
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, pat.gender,rg.name, EXTRACT(YEAR FROM a.drcpt)" +
" ORDER BY cdc_age_cat.id DESC", nativeQuery = true) 
List<Object[]> getPatientMaleByAgeCdcForOnRegimen(@Param("year") int year, @Param("regimenId") Long regimenId, @Param("sex") String sex);
...
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, pat.gender,rg.name, EXTRACT(YEAR FROM a.drcpt) " +
" ORDER BY  cdc_age_cat.id DESC", nativeQuery = true) 
List<Object[]> getPatientFemaleByAgeCdcForOnRegimen(@Param("year") int year, @Param("regimenId") Long regimenId, @Param("sex") String sex);
...
" GROUP BY pat.gender, cdc_age_cat.id, cdc_age_cat.label, rg.name, EXTRACT(YEAR FROM a.drcpt)" +
 "ORDER BY cdc_age_cat.id DESC ", nativeQuery = true) 
List<Object[]> getTestMaleByAgeCdcForOneRegimen(@Param("year") int year, @Param("regimenId") Long regimenId, @Param("sex") String sex);
...
" GROUP BY pat.gender, cdc_age_cat.id, cdc_age_cat.label, rg.name, EXTRACT(YEAR FROM a.drcpt)" +
 "ORDER BY cdc_age_cat.id DESC ", nativeQuery = true) 
List<Object[]> getTestFemaleByAgeCdcForOneRegimen(@Param("year") int year, @Param("regimenId") Long regimenId, @Param("sex") String sex);



@Query(value =  " SELECT reg.id, reg.name, cdc_age_cat.id, cdc_age_cat.label, " +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" cdc_age_cat.id = :ageCategoryId AND " +
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY reg.id, reg.name, cdc_age_cat.id, cdc_age_cat.label, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByAgeCdcForRegion(@Param("year") int year, @Param("ageCategoryId") Long ageCategoryId);


@Query(value =  " SELECT cdc_age_cat.id, cdc_age_cat.label, part.id, part.name," +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" cdc_age_cat.id = :ageCategoryId AND " +
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, part.id, part.name, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByAgeCdcForPartner(@Param("year") int year, @Param("ageCategoryId") Long ageCategoryId);

@Query(value =  " SELECT cdc_age_cat.id, cdc_age_cat.label, dis.id, dis.name," +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" cdc_age_cat.id = :ageCategoryId AND " +
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, dis.id, dis.name, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByAgeCdcForDistrict(@Param("year") int year, @Param("ageCategoryId") Long ageCategoryId);


@Query(value =  " SELECT cdc_age_cat.id, cdc_age_cat.label, s.id, s.new_site_short_name," +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" cdc_age_cat.id = :ageCategoryId AND " +
" EXTRACT(YEAR FROM a.drcpt) = :year  " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, s.id, s.new_site_short_name, EXTRACT(YEAR FROM a.drcpt)", nativeQuery = true) 
List<Object[]> getPatientByAgeCdcForSite(@Param("year") int year, @Param("ageCategoryId") Long ageCategoryId);

//SUPPRESSION VIRALE - PAR AGE - POUR TOUTE TRANCHE D'AGE
      //NOTATION NATIONALE
@Query(value =  " SELECT cdc_age_cat.id, cdc_age_cat.label,  " +
" SUM(CASE WHEN a.converted_result >= 1000 THEN 1 ELSE 0 END) AS TOTAL_NON_SUPPRIME, " +
" SUM(CASE WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END ) AS TOTAL_SUPPRIME, " +
" ROUND(SUM(CASE WHEN a.converted_result = 0 THEN 1 WHEN a.converted_result < 1000 AND a.converted_result > 0 THEN 1 ELSE 0 END) * 100.0 / SUM(1), 2) AS POURCENTAGE_SUPPRIME " +
" FROM  dashboard.analysis a " +
...
" WHERE cdc_age_cat.type = 'National' AND " +   
" EXTRACT(YEAR FROM a.drcpt) = :year " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, EXTRACT(YEAR FROM a.drcpt)" +
" ORDER BY cdc_age_cat.id ASC " , nativeQuery = true) 
...
" JOIN dashboard.partner part on part.id = site_part.partner_id " +
" JOIN dashboard.regimen rg on rg.id = a.regimen_id " +
" WHERE cdc_age_cat.type = 'National' AND a.age_national_id = :ageCategoryId AND " +   
" EXTRACT(YEAR FROM a.drcpt) = :year " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, EXTRACT(YEAR FROM a.drcpt)" +
" ORDER BY cdc_age_cat.id ASC " , nativeQuery = true) 
...
" JOIN dashboard.partner part on part.id = site_part.partner_id " +
" JOIN dashboard.regimen rg on rg.id = a.regimen_id " +
" WHERE cdc_age_cat.type = 'CDC CI' AND a.age_cdc_id = :ageCategoryId AND " +   
" EXTRACT(YEAR FROM a.drcpt) = :year " +
" GROUP BY cdc_age_cat.id, cdc_age_cat.label, EXTRACT(YEAR FROM a.drcpt)" +
" ORDER BY cdc_age_cat.id ASC " , nativeQuery = true) 
...
@Query(value =  " select formatted_date, yearmonth,label,SUM(total_tests)  " +
" from ( SELECT DISTINCT TO_CHAR(a.drcpt, 'Mon-YYYY') AS formatted_date,TO_CHAR(a.drcpt, 'YYYYMM') AS yearmonth,  st.label as label, a.drcpt as receipt_date, " +
" COUNT(t.id) AS total_tests " +
" FROM dashboard.region r" +
" INNER JOIN dashboard.district d ON r.id = d.region_id " +
" INNER JOIN dashboard.site s ON d.id = s.district_id " +
...
" WHERE st.label = 'DBS' AND a.regimen_id = :regimenId " +
" AND a.drcpt BETWEEN '2022-01-01' AND CURRENT_DATE " + 
" GROUP BY a.drcpt, TO_CHAR(a.drcpt, 'Mon-YYYY'),yearmonth, st.label " + 
" ORDER BY a.drcpt ASC ) req1 " + 
" GROUP BY formatted_date, yearmonth,label " +
